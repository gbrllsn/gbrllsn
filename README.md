...
* **Weekly Technician Performance & KPI Tracking Report** *(MS Excel)*  
  Built an automated operations dashboard tracking closing rates, revenue collection, and dynamic incentive bonus structures.
* **Financial Total Cost of Ownership (TCO) & Inventory Tracker** *(MS Excel)*  
  Formulated a multi-variable financial comparison model and an automated inventory restock alert system using logical formulas.

---

### 🛠️ Tech Stack & Tools

![SQL](https://img.shields.io/badge/SQL-MySQL-00758F?style=flat&logo=mysql&logoColor=white)
